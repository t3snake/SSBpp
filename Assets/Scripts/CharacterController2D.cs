...
public class CharacterController2D : MonoBehaviour {
	...
	IEnumerator KillPlayer()
	{
		if (playerCanMove)
		{
			...
			cam.GetComponent<Camera2DFollow>().DetachCamera();
			//Transform old_target = cam.GetComponent<Camera2DFollow>().target;
			//cam.GetComponent<Camera2DFollow>().target = null;
			...
			//old_target = cam.GetComponent<Camera2DFollow>().target;
			cam.GetComponent<Camera2DFollow>().AttachCamera();
		}
	}
